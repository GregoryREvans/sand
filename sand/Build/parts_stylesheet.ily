...
\layout {
	...
	\context {
        ...
        \override VerticalAxisGroup.default-staff-staff-spacing = #'((basic-distance . 16) (minimum-distance . 16) (padding . 4) (stretchability . 0))
    }
    \context {
        \Score
        ...
        \override StaffGrouper.staff-staff-spacing = #'((basic-distance . 16) (minimum-distance . 16) (padding . 4))
