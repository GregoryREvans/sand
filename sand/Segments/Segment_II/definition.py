...
saxophone_notes_one = [
    saxophone_chord_one[x] for x in reduceMod9(saxophone_random_walk_one)
]
...
saxophone_notes_two = [
    saxophone_chord_two[x] for x in reduceMod3(saxophone_random_walk_two)
]
...
saxophone_notes_three = [
    saxophone_chord_three[x] for x in reduceMod3(saxophone_random_walk_three)
]
...
rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[3, 1, 3, 1, 3, 1, 3, 1, 3, 1], denominator=16),
...
rmaker_two = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[1, 2, 2, 3, 3, 3, 2, 2, 1], denominator=16),
    beam_specifier=abjadext.rmakers.BeamSpecifier(
        beam_divisions_together=True, beam_rests=False
    ),
...
attachment_handler_three = AttachmentHandler(
    starting_dynamic="pp", ending_dynamic="mf", hairpin_indicator="<", articulation=""
)
