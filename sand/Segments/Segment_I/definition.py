...
saxophone_notes_one = [
    saxophone_chord_one[x] for x in reduceMod7(saxophone_random_walk_one)
]
...
rmaker_one = abjadext.rmakers.TaleaRhythmMaker(
    talea=abjadext.rmakers.Talea(counts=[2, 7, 2, 3, 2, 4, 7, 2, 5, 6], denominator=32),
...
attachment_handler_three = AttachmentHandler(
    starting_dynamic="ff", ending_dynamic="mp", hairpin_indicator="|>", articulation=""
)
